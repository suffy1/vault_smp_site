...
export default async (request, context) => {
  try {
    ...
    // GÜNCELLEME: Neon için SSL (TLS) ayarlarını zorluyoruz
    const client = new Client({
      url: dbUrl,
      tls: {
        enabled: true,
        enforce: false, // Sertifika hatalarını görmezden gel (bazen gereklidir)
      },
    });
    ...
    // Hatayı Netlify loglarında görebilmemiz için konsola yazdırıyoruz
